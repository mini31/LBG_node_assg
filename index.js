...
var _assg = __webpack_require__(27);

var _assg2 = _interopRequireDefault(_assg);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

_reactDom2.default.render(_react2.default.createElement(_assg2.default, null), document.getElementById('app'));
...
var _task3 = __webpack_require__(34);

var _task4 = _interopRequireDefault(_task3);

var _task5 = __webpack_require__(35);
...
function _inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function, not " + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; } //importing react modules


//importing Superagent


var Task1 = function (_Component) {
  _inherits(Task1, _Component);
  ...
  _createClass(Task1, [{
    ...
    value: function componentDidMount() {
      ...
      _superagent2.default.get('/task1').then(function (res) {
        ...
        _this2.setState({ component: comp });
      });
    }
  }, {
    key: 'render',
...
var Task2 = function (_Component) {
  _inherits(Task2, _Component);
  ...
  function Task2(props) {
    ...
    _this.state = {
      ...
      //event handlers
    };_this.handleTextField1 = _this.handleTextField1.bind(_this);
    _this.handleTextField2 = _this.handleTextField2.bind(_this);
  ...
  _createClass(Task2, [{
    key: 'handleTextField1',
    value: function handleTextField1(e) {
      //storing the value
      this.setState({ value1: e.target.value });
    }
  }, {
    key: 'handleTextField2',
    value: function handleTextField2(e) {
      //storing the value
    ...
    value: function handleSubmit() {
      ...
      _superagent2.default.get('/task2').query({ value1: this.state.value1, value2: this.state.value2 }).then(function (res) {
        var comp = _react2.default.createElement(
          'center',
          null,
          _react2.default.createElement(
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement('input', { type: 'text', placeholder: 'enter number 1', onChange: this.handleTextField1 }),
          _react2.default.createElement('input', { type: 'text', placeholder: 'enter number 2', onChange: this.handleTextField2 }),
...
var Task2 = function (_Component) {
  ...
  _createClass(Task2, [{
    ...
    value: function handleSubmit() {
      ...
      _superagent2.default.get('/task3').query({ value: this.state.value }).then(function (res) {
        var comp = _react2.default.createElement(
          'center',
          null,
          _react2.default.createElement(
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement('input', { type: 'text', placeholder: 'enter a name', onChange: this.handleTextField1 }),
          _react2.default.createElement('input', { type: 'submit', value: 'Submit', onClick: this.handleSubmit }),
          this.state.component
        )
      );
